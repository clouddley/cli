...
// installCmd represents the install command (DEPRECATED)
var installCmd = &cobra.Command{
	Use:        "install",
	Aliases:    []string{"i"},
	Short:      "Install SSH Public Key (DEPRECATED)",
	Long:       `Install triggr's SSH public key on your server to enable secure communication between your server and the Clouddley Platform. DEPRECATED: Use 'clouddley add key' instead.`,
	Example:    "clouddley triggr install",
	Deprecated: "use 'clouddley add key' instead",
	Run: func(cmd *cobra.Command, args []string) {
		log.Warn("DEPRECATION WARNING: 'clouddley triggr install' is deprecated. Please use 'clouddley add key' instead.")
